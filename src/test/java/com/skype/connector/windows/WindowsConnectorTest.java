...
public final class WindowsConnectorTest  {
    ...
    public void testAttachedAfterTryingToConnect() throws Exception {
        ...
        Assert.assertEquals(Connector.Status.ATTACHED, WindowsConnector.getInstance().connect());
    }
    ...
    public void testRefusedAfterTryingToConnect() throws Exception {
        ...
        Assert.assertEquals(Connector.Status.REFUSED, WindowsConnector.getInstance().connect());
    ...
    public void testNotAvailableAfterTryingToConnect() throws Exception {
        ...
        Assert.assertEquals(Connector.Status.NOT_AVAILABLE, WindowsConnector.getInstance().connect());
    ...
    public void testNotRunnigAfterTryingToConnect() throws Exception {
        ...
        Assert.assertEquals(Connector.Status.NOT_RUNNING, WindowsConnector.getInstance().connect());
        TestUtils.showMessageDialog("Launch Skype for next test, please.");
    }

	@Test
    public void testGetInstalledPath() {
        Assert.assertEquals("C:\\Program Files\\Skype\\Phone\\Skype.exe", WindowsConnector.getInstance().getInstalledPath());
    }
}
